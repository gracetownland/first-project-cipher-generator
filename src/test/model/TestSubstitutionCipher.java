...
//        int moveBy=1;
//        assertEquals("BCDEFG",new SubstitutionCipher(toBeEncrypted, Integer.toString(moveBy)));
//    }
//    @Test
...
//        String unEncrypted= new SubstitutionCipher(toBeEncrypted, Integer.toString(moveBy));
